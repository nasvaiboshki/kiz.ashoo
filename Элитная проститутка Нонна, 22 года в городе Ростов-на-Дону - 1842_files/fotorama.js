...
fotoramaVersion = "4.6.4",
    function (a, b, c, d, e) {
        ...
        function w() {
            for (var a, b = 0, c = arguments.length; b < c && "number" != typeof (a = b ? arguments[b]() : arguments[b]); b++);
            return a
        }
        ...
        function K(a, b, c) {
            return b !== c && (a <= b ? "left" : a >= c ? "right" : "left right")
        }
        ...
        function ca(a, c) {
            function e(a) {
                if (m = d(a.target), u.checked = p = q = s = !1, k || u.flow || a.touches && a.touches.length > 1 || a.which > 1 || ec && ec.type !== a.type && gc || (p = c.select && m.is(c.select, t))) return p;
                o = "touchstart" === a.type, q = m.is("a, a *", t), n = u.control, r = u.noMove || u.noSwipe || n ? 16 : u.snap ? 0 : 4, ba(a), l = ec = a, fc = a.type.replace(/down|start/, "move").replace(/Down/, "Move"), (c.onStart || g).call(t, a, {
                    control: n,
                    $target: m
                }), k = u.flow = !0, o && !u.go || Y(a)
            }
        ...
        function da(a, b) {
            ...
            function f(d, e) {
                D.noSwipe || (A || c(d), l = d._x, p.push([d._now, l]), n = m - (j - l), o = K(n, s, t), n <= s ? n = x(n, s) : n >= t && (n = x(n, t)), D.noMove || (a.css(k(n)), z || (z = !0, e.touch || Nb || a.addClass(eb)), (b.onMove || g).call(B, d, {
                    pos: n,
                    edge: o
                })))
            }
            ...
            function i(e) {
                if (!D.noSwipe || !e.moved) {
                    ...
                    for (var f, i, j, k, o, q, v, x, y, z = r - Pb, C = null, E = Qb, F = b.friction, G = p.length - 1; G >= 0; G--) {
                        if (f = p[G][0], i = Math.abs(f - z), null === C || i < j) C = f, k = p[G][1];
                    ...
                    var H = k - l,
                        ...
                        K = J > Pb,
                        L = !K && n !== m && v === n;
                    u && (v = h(Math[L ? I ? "floor" : "ceil" : "round"](n / u) * u, s, t), s = t = v), L && (u || v === n) && (y = -H / J, E *= h(Math.abs(y), b.timeLow, b.timeHigh), o = Math.round(n + y * E / F), u || (v = o), (!I && o > t || I && o < s) && (q = I ? s : t, x = o - q, u || (v = q), x = h(v + .03 * x, q - 50, q + 50), E = Math.abs((n - x) / (y / F)))), E *= w ? 10 : 1, (b.onEnd || g).call(B, d.extend(e, {
                        moved: e.moved || K && u,
                        pos: n,
                        newPos: v,
                        overPos: x,
        ...
        if (void 0 !== b.cancelFullScreen) vb.ok = !0;
            ...
            for (var xb = 0, yb = wb.length; xb < yb; xb++)
        ...
        ! function (a, b) {
            ...
            function k(a) {
                if (void 0 === this) return new k(a);
                this.opts = h(a || {}, k.defaults, q)
            }
        ...
        jQuery.Fotorama = function (a, e) {
            ...
            function o() {
                var a = zc < 2 && !e.enableifsingleframe || Cc;
            ...
            function x(a) {
                return a < 0 ? (zc + a % zc) % zc : a >= zc ? a % zc : a
            }
                ...
                ca(a, b, function (a, i, j, k, l, m) {
                    ...
                    if (k) {
                        ...
                        if (!m.$img || h || r) {
                            ...
                            }() : (d.Fotorama.cache[w] = "*", t.on("load", q).on("error", o)), m.state = "", m.data.hasOwnProperty("alt") && (s.alt = m.data.alt), m.data.hasOwnProperty("title") && (s.title = m.data.title), s.src = w
                        }
                    }
                })
            }
            ...
            function wb(a, b, c) {
                if (!wb[c]) {
                    ...
                    b.append(a.filter(function () {
                        for (var a, b = d(this), c = b.data(), e = 0, f = yc.length; e < f; e++)
                            if (c.data === yc[e]) {
                                a = !0, c.eq = e;
                                break
                            } return a || b.remove() && !1
            ...
            function wc() {
                if (!wc.f === Yc) return wc.f = Yc, Jd = zc - 1 - Jd, id.reverse(), !0
            }
