...
! function (e, t) {
    ...
    var v = function (e) {
        ...
        function a(t) {
            ...
            return i = e.call.apply(e, [this].concat(t)) || this, a = function (e) {
                ...
                return e
            }(i), n = a.__proto__, Object.defineProperty(a, "__proto__", {
                get: function () {
                    return n
                },
                set: function (e) {
    ...
    function m(e, t) {
        ...
        if ("string" == typeof e) {
            ...
            if (s.indexOf("<") >= 0 && s.indexOf(">") >= 0) {
                ...
                d.innerHTML = s;
                for (var p = 0; p < d.childNodes.length; p += 1) n.push(d.childNodes[p])
            } else n = function (e, t) {
    ...
    var g, y, b, C = {
            ...
            function o(e) {
                ...
                if (t) {
                    ...
                    if (i.indexOf(e) < 0 && i.unshift(e), m(t).is(n)) r.apply(t, i);
                        ...
                        for (var a = m(t).parents(), s = 0; s < a.length; s += 1) m(a[s]).is(n) && r.apply(a[s], i)
                }
            }
                ...
                for (var d = o[l], p = 0; p < this.length; p += 1) {
                    ...
                    if (!n && u.dom7Listeners ? c = u.dom7Listeners[d] : n && u.dom7LiveListeners && (c = u.dom7LiveListeners[d]), c && c.length)
                        for (var v = c.length - 1; v >= 0; v -= 1) {
                            var f = c[v];
                            r && f.listener === r || r && f.listener && f.listener.dom7proxy && f.listener.dom7proxy === r ? (u.removeEventListener(d, f.proxyListener, s), c.splice(v, 1)) : r || (u.removeEventListener(d, f.proxyListener, s), c.splice(v, 1))
                        }
                }
            return this
        },
        ...
        children: function (e) {
            for (var t = [], i = 0; i < this.length; i += 1)
                for (var a = this[i].children, n = 0; n < a.length; n += 1) e && !m(a[n]).is(e) || t.push(a[n]);
            return m(t)
        },
        filter: function (e) {
            return m(h(this, e))
        ...
        for (var e = Object(arguments.length <= 0 ? void 0 : arguments[0]), t = 1; t < arguments.length; t += 1) {
            ...
            if (null != i)
                for (var a = Object.keys(Object(i)), n = 0, r = a.length; n < r; n += 1) {
                    ...
                    void 0 !== o && o.enumerable && (E(e[s]) && E(i[s]) ? S(e[s], i[s]) : !E(e[s]) && E(i[s]) ? (e[s] = {}, S(e[s], i[s])) : e[s] = i[s])
                }
        }
        return e
    }
    ...
    function x(e, t) {
        Object.keys(t).forEach((function (i) {
            E(t[i]) && Object.keys(t[i]).forEach((function (a) {
    ...
    function k(e) {
        return void 0 === e && (e = {}), y || (y = function (e) {
            var t = (void 0 === e ? {} : e).userAgent,
                ...
                f = "Win32" === n,
                h = "MacIntel" === n;
            return !u && h && i.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(l + "x" + d) >= 0 && ((u = r.match(/(Version)\/([\d.]+)/)) || (u = [0, 1, "13_0_0"]), h = !1), p && !f && (s.os = "android", s.android = !0), (u || v || c) && (s.os = "ios", s.ios = !0), s
        }(e)), y
    }
        ...
        if (!t.animating || !s.preventInteractionOnTransition) {
            ...
            if ("wrapper" !== s.touchEventsTarget || p.closest(t.wrapperEl).length)
                if (n.isTouchEvent = "touchstart" === d.type, n.isTouchEvent || !("which" in d) || 3 !== d.which)
                    if (!(!n.isTouchEvent && "button" in d && d.button > 0))
                        if (!n.isTouched || !n.isMoved)
                            if (!!s.noSwipingClass && "" !== s.noSwipingClass && d.target && d.target.shadowRoot && e.path && e.path[0] && (p = m(e.path[0])), s.noSwiping && p.closest(s.noSwipingSelector ? s.noSwipingSelector : "." + s.noSwipingClass)[0]) t.allowClick = !0;
                ...
                if (S(n, {
                        ...
                        isScrolling: void 0,
                        startMoving: void 0
                    }), l.startX = u, l.startY = c, n.touchStartTime = T(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, s.threshold > 0 && (n.allowThresholdMove = !1), "touchstart" !== d.type) {
                    var h = !0;
                    p.is(n.formElements) && (h = !1), i.activeElement && m(i.activeElement).is(n.formElements) && i.activeElement !== p[0] && i.activeElement.blur();
                    var g = h && t.allowTouchMove && s.touchStartPreventDefault;
                    !s.touchStartForcePreventDefault && !g || p[0].isContentEditable || d.preventDefault()
                }
                t.emit("touchStart", d)
            }
        }
    ...
    function A(e) {
        ...
        if (l.originalEvent && (l = l.originalEvent), a.isTouched) {
            if (!a.isTouchEvent || "touchmove" === l.type) {
                ...
                if (!i.allowTouchMove) return i.allowClick = !1, void(a.isTouched && (S(s, {
                    startX: p,
                    startY: u,
                    currentX: p,
                    currentY: u
                ...
                if (a.isTouchEvent && n.touchReleaseOnEdges && !n.loop)
                    if (i.isVertical()) {
                        if (u < s.startY && i.translate <= i.maxTranslate() || u > s.startY && i.translate >= i.minTranslate()) return a.isTouched = !1, void(a.isMoved = !1)
                ...
                if (a.allowTouchCallbacks && i.emit("touchMove", l), !(l.targetTouches && l.targetTouches.length > 1)) {
                    ...
                    if (!(i.params.threshold && Math.sqrt(Math.pow(c, 2) + Math.pow(v, 2)) < i.params.threshold)) {
                        var f;
                        if (void 0 === a.isScrolling) i.isHorizontal() && s.currentY === s.startY || i.isVertical() && s.currentX === s.startX ? a.isScrolling = !1 : c * c + v * v >= 25 && (f = 180 * Math.atan2(Math.abs(v), Math.abs(c)) / Math.PI, a.isScrolling = i.isHorizontal() ? f > n.touchAngle : 90 - f > n.touchAngle);
                        if (a.isScrolling && i.emit("touchMoveOpposite", l), void 0 === a.startMoving && (s.currentX === s.startX && s.currentY === s.startY || (a.startMoving = !0)), a.isScrolling) a.isTouched = !1;
        ...
        if (i.isTouched = !1, i.isMoved = !1, i.startMoving = !1, p = a.followFinger ? r ? t.translate : -t.translate : -i.currentTranslate, !a.cssMode)
            if (a.freeMode) {
                ...
                if (a.freeModeMomentum) {
                    ...
                    if (b < t.maxTranslate()) a.freeModeMomentumBounce ? (b + t.maxTranslate() < -x && (b = t.maxTranslate() - x), C = t.maxTranslate(), S = !0, i.allowMomentumBounce = !0) : b = t.maxTranslate(), a.loop && a.centeredSlides && (E = !0);
                    else if (b > t.minTranslate()) a.freeModeMomentumBounce ? (b - t.minTranslate() > x && (b = t.minTranslate() + x), C = t.minTranslate(), S = !0, i.allowMomentumBounce = !0) : b = t.minTranslate(), a.loop && a.centeredSlides && (E = !0);
                    ...
                    a.freeModeMomentumBounce && S ? (t.updateProgress(C), t.setTransition(g), t.setTranslate(b), t.transitionStart(!0, t.swipeDirection), t.animating = !0, s.transitionEnd((function () {
                        t && !t.destroyed && i.allowMomentumBounce && (t.emit("momentumBounce"), t.setTransition(a.speed), setTimeout((function () {
                            t.setTranslate(C), s.transitionEnd((function () {
    ...
    var H = {
        ...
        R = {
            ...
            update: {
                ...
                updateSlides: function () {
                    var e = this,
                        ...
                        l = e.rtlTranslate,
                        d = e.wrongRTL,
                        p = e.virtual && n.virtual.enabled,
                        u = p ? e.virtual.slides.length : e.slides.length,
                        c = r.children("." + e.params.slideClass),
                        v = p ? e.virtual.slides.length : c.length,
                        f = [],
                        h = [],
                        m = [],
                    ...
                    if (void 0 !== s) {
                        var M, k;
                        "string" == typeof w && w.indexOf("%") >= 0 && (w = parseFloat(w.replace("%", "")) / 100 * s), e.virtualSize = -w, l ? c.css({
                            marginLeft: "",
                            marginTop: ""
                        }) : c.css({
                            marginRight: "",
                            marginBottom: ""
                        }), n.slidesPerColumn > 1 && (M = Math.floor(v / n.slidesPerColumn) === v / e.params.slidesPerColumn ? v : Math.ceil(v / n.slidesPerColumn) * n.slidesPerColumn, "auto" !== n.slidesPerView && "row" === n.slidesPerColumnFill && (M = Math.max(M, n.slidesPerView * n.slidesPerColumn)));
                        for (var P, L, z, O = n.slidesPerColumn, I = M / O, A = Math.floor(v / n.slidesPerColumn), B = 0; B < v; B += 1) {
                            k = 0;
                            var D = c.eq(B);
                            if (n.slidesPerColumn > 1) {
                                ...
                                if ("row" === n.slidesPerColumnFill && n.slidesPerGroup > 1) {
                                    var F = Math.floor(B / (n.slidesPerGroup * n.slidesPerColumn)),
                                        H = B - n.slidesPerColumn * n.slidesPerGroup * F,
                                        R = 0 === F ? n.slidesPerGroup : Math.min(Math.ceil((v - F * O * n.slidesPerGroup) / O), n.slidesPerGroup);
                                    N = ($ = H - (G = Math.floor(H / R)) * R + F * n.slidesPerGroup) + G * M / O, D.css({
                                ...
                                } else "column" === n.slidesPerColumnFill ? (G = B - ($ = Math.floor(B / O)) * O, ($ > A || $ === A && G === O - 1) && (G += 1) >= O && (G = 0, $ += 1)) : $ = B - (G = Math.floor(B / I)) * I;
                                D.css(t("margin-top"), 0 !== G && n.spaceBetween && n.spaceBetween + "px")
                            }
                            if ("none" !== D.css("display")) {
                                if ("auto" === n.slidesPerView) {
                                    var V = a.getComputedStyle(D[0], null),
                                        j = D[0].style.transform,
                                        _ = D[0].style.webkitTransform;
                                    if (j && (D[0].style.transform = "none"), _ && (D[0].style.webkitTransform = "none"), n.roundLengths) k = e.isHorizontal() ? D.outerWidth(!0) : D.outerHeight(!0);
                                    else {
                                        var W = i(V, "width"),
                                            q = i(V, "padding-left"),
                                            X = i(V, "padding-right"),
                                        ...
                                        if (K && "border-box" === K) k = W + Y + U;
                                        else {
                                            var J = D[0],
                                                Q = J.clientWidth;
                                            k = W + q + X + Y + U + (J.offsetWidth - Q)
                                        }
                                    }
                                    j && (D[0].style.transform = j), _ && (D[0].style.webkitTransform = _), n.roundLengths && (k = Math.floor(k))
                                } else k = (s - (n.slidesPerView - 1) * w) / n.slidesPerView, n.roundLengths && (k = Math.floor(k)), c[B] && (c[B].style[t("width")] = k + "px");
                                c[B] && (c[B].swiperSlideSize = k), m.push(k), n.centeredSlides ? (T = T + k / 2 + E / 2 + w, 0 === E && 0 !== B && (T = T - s / 2 - w), 0 === B && (T = T - s / 2 - w), Math.abs(T) < .001 && (T = 0), n.roundLengths && (T = Math.floor(T)), x % n.slidesPerGroup == 0 && f.push(T), h.push(T)) : (n.roundLengths && (T = Math.floor(T)), (x - Math.min(e.params.slidesPerGroupSkip, x)) % e.params.slidesPerGroup == 0 && f.push(T), h.push(T), T = T + k + w), e.virtualSize += k + w, E = k, x += 1
                            }
                        }
                        if (e.virtualSize = Math.max(e.virtualSize, s) + y, l && d && ("slide" === n.effect || "coverflow" === n.effect) && r.css({
                                width: e.virtualSize + n.spaceBetween + "px"
                            }), n.setWrapperSize) r.css(((L = {})[t("width")] = e.virtualSize + n.spaceBetween + "px", L));
                        if (n.slidesPerColumn > 1)
                            if (e.virtualSize = (k + n.spaceBetween) * M, e.virtualSize = Math.ceil(e.virtualSize / n.slidesPerColumn) - n.spaceBetween, r.css(((z = {})[t("width")] = e.virtualSize + n.spaceBetween + "px", z)), n.centeredSlides) {
                                P = [];
                                for (var Z = 0; Z < f.length; Z += 1) {
                                    var ee = f[Z];
                                    n.roundLengths && (ee = Math.floor(ee)), f[Z] < e.virtualSize + f[0] && P.push(ee)
                                }
                                f = P
                            } if (!n.centeredSlides) {
                            P = [];
                            for (var te = 0; te < f.length; te += 1) {
                                var ie = f[te];
                                n.roundLengths && (ie = Math.floor(ie)), f[te] <= e.virtualSize - s && P.push(ie)
                            }
                        ...
                        S(e, {
                            ...
                            slidesGrid: h,
                            slidesSizesGrid: m
                        }), v !== u && e.emit("slidesLengthChange"), f.length !== b && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), h.length !== C && e.emit("slidesGridLengthChange"), (n.watchSlidesProgress || n.watchSlidesVisibility) && e.updateSlidesOffset()
                    }
                },
                    ...
                    if (0 !== a.length) {
                        ...
                        for (var s = 0; s < a.length; s += 1) {
                            ...
                            if (i.watchSlidesVisibility || i.centeredSlides && i.autoHeight) {
                                ...
                                (d >= 0 && d < t.size - 1 || p > 1 && p <= t.size || d <= 0 && p >= t.size) && (t.visibleSlides.push(o), t.visibleSlidesIndexes.push(s), a.eq(s).addClass(i.slideVisibleClass))
                            }
                            o.progress = n ? -l : l
                        }
                ...
                updateProgress: function (e) {
                    ...
                    var a = t.params,
                        ...
                        l = s,
                        d = o;
                    0 === n ? (r = 0, s = !0, o = !0) : (s = (r = (e - t.minTranslate()) / n) <= 0, o = r >= 1), S(t, {
                        progress: r,
                        isBeginning: s,
                        isEnd: o
                ...
                updateActiveIndex: function (e) {
                    ...
                    if (r.indexOf(a) >= 0) t = r.indexOf(a);
                        ...
                        var c = Math.min(s.slidesPerGroupSkip, p);
                        t = c + Math.floor((p - c) / s.slidesPerGroup)
                    }
                ...
                updateClickedSlide: function (e) {
                    var t, i = this,
                        a = i.params,
                        n = m(e.target).closest("." + a.slideClass)[0],
                        r = !1;
                    if (n)
                    ...
                    i.clickedSlide = n, i.virtual && i.params.virtual.enabled ? i.clickedIndex = parseInt(m(n).attr("data-swiper-slide-index"), 10) : i.clickedIndex = t, a.slideToClickedSlide && void 0 !== i.clickedIndex && i.clickedIndex !== i.activeIndex && i.slideToClickedSlide()
                }
            },
            translate: {
                ...
                translateTo: function (e, t, i, a, n) {
                    ...
                    var l, d = r.minTranslate(),
                        p = r.maxTranslate();
                    if (l = a && e > d ? d : a && e < p ? p : e, r.updateProgress(l), s.cssMode) {
            ...
            slide: {
                slideTo: function (e, t, i, a) {
                    ...
                    h >= l.length && (h = l.length - 1), (u || o.initialSlide || 0) === (p || 0) && i && r.emit("beforeSlideChangeStart");
                    var m, g = -l[h];
                    if (r.updateProgress(g), o.normalizeSlideIndex)
                        for (var y = 0; y < d.length; y += 1) {
                            ...
                            void 0 !== d[y + 1] ? b >= C && b < w - (w - C) / 2 ? s = y : b >= C && b < w && (s = y + 1) : b >= C && (s = y)
                        }
                    if (r.initialized && s !== u) {
                        if (!r.allowSlideNext && g < r.translate && g < r.minTranslate()) return !1;
                        if (!r.allowSlidePrev && g > r.translate && g > r.maxTranslate() && (u || 0) !== s) return !1
                    }
                    if (m = s > u ? "next" : s < u ? "prev" : "reset", c && -g === r.translate || !c && g === r.translate) return r.updateActiveIndex(s), o.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), "slide" !== o.effect && r.setTranslate(g), "reset" !== m && (r.transitionStart(i, m), r.transitionEnd(i, m)), !1;
                    if (o.cssMode) {
                        var T, E = r.isHorizontal(),
                            S = -g;
                        if (c && (S = v.scrollWidth - v.offsetWidth - S), 0 === t) v[E ? "scrollLeft" : "scrollTop"] = S;
                        else if (v.scrollTo) v.scrollTo(((T = {})[E ? "left" : "top"] = S, T.behavior = "smooth", T));
                        else v[E ? "scrollLeft" : "scrollTop"] = S;
                        return !0
                    }
                ...
                slidePrev: function (e, t, i) {
                    ...
                    s[u.indexOf(p)];
                    var c, v = s[u.indexOf(p) - 1];
                    return void 0 === v && n.cssMode && s.forEach((function (e) {
                        !v && p >= e && (v = e)
                ...
                slideToClosest: function (e, t, i, a) {
                    ...
                    if (l >= n.snapGrid[o]) {
                        ...
                        l - p <= (n.snapGrid[o] - p) * a && (r -= n.params.slidesPerGroup)
                    }
                ...
                slideToClickedSlide: function () {
                    ...
                    if (i.loop) {
                        ...
                        e = parseInt(m(t.clickedSlide).attr("data-swiper-slide-index"), 10), i.centeredSlides ? r < t.loopedSlides - n / 2 || r > t.slides.length - t.loopedSlides + n / 2 ? (t.loopFix(), r = a.children("." + i.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), w((function () {
                            t.slideTo(r)
                        }))) : t.slideTo(r) : r > t.slides.length - n ? (t.loopFix(), r = a.children("." + i.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), w((function () {
                            t.slideTo(r)
                        }))) : t.slideTo(r)
                    } else t.slideTo(r)
                }
            ...
            loop: {
                loopCreate: function () {
                    ...
                    n.each((function (t, i) {
                        var a = m(t);
                        i < e.loopedSlides && p.push(t), i < n.length && i >= n.length - e.loopedSlides && d.push(t), a.attr("data-swiper-slide-index", i)
                    }));
                ...
                loopFix: function () {
                    ...
                    if (i < n) t = a.length - 3 * n + i, t += n, e.slideTo(t, 0, !1, !0) && 0 !== d && e.setTranslate((l ? -e.translate : e.translate) - d);
                    else if (i >= a.length - n) {
                        t = -a.length + i + n, t += n, e.slideTo(t, 0, !1, !0) && 0 !== d && e.setTranslate((l ? -e.translate : e.translate) - d)
                    }
            ...
            events: {
                attachEvents: function () {
                    var e = this,
                        ...
                        o = e.device,
                        l = e.support;
                    e.onTouchStart = I.bind(e), e.onTouchMove = A.bind(e), e.onTouchEnd = B.bind(e), i.cssMode && (e.onScroll = $.bind(e)), e.onClick = N.bind(e);
                    var d = !!i.nested;
                    if (!l.touch && l.pointerEvents) n.addEventListener(a.start, e.onTouchStart, !1), t.addEventListener(a.move, e.onTouchMove, d), t.addEventListener(a.end, e.onTouchEnd, !1);
                        ...
                        if (l.touch) {
                            ...
                            n.addEventListener(a.start, e.onTouchStart, p), n.addEventListener(a.move, e.onTouchMove, l.passiveListener ? {
                                passive: !1,
                                capture: d
                            } : d), n.addEventListener(a.end, e.onTouchEnd, p), a.cancel && n.addEventListener(a.cancel, e.onTouchEnd, p), G || (t.addEventListener("touchstart", F), G = !0)
                ...
                detachEvents: function () {
                    ...
                    if (!l.touch && l.pointerEvents) n.removeEventListener(a.start, e.onTouchStart, !1), t.removeEventListener(a.move, e.onTouchMove, d), t.removeEventListener(a.end, e.onTouchEnd, !1);
                        ...
                        if (l.touch) {
                            ...
                            n.removeEventListener(a.start, e.onTouchStart, p), n.removeEventListener(a.move, e.onTouchMove, d), n.removeEventListener(a.end, e.onTouchEnd, p), a.cancel && n.removeEventListener(a.cancel, e.onTouchEnd, p)
                ...
                setBreakpoint: function () {
                    ...
                    if (o && (!o || 0 !== Object.keys(o).length)) {
                        ...
                        if (l && e.currentBreakpoint !== l) {
                            ...
                            u && !c ? (s.removeClass(r.containerModifierClass + "multirow " + r.containerModifierClass + "multirow-column"), e.emitContainerClasses()) : !u && c && (s.addClass(r.containerModifierClass + "multirow"), "column" === p.slidesPerColumnFill && s.addClass(r.containerModifierClass + "multirow-column"), e.emitContainerClasses());
                            var v = p.direction && p.direction !== r.direction,
                                f = r.loop && (p.slidesPerView !== r.slidesPerView || v);
                            v && i && e.changeDirection(), S(e.params, p), S(e, {
                                allowTouchMove: e.params.allowTouchMove,
                                allowSlideNext: e.params.allowSlideNext,
                                allowSlidePrev: e.params.allowSlidePrev
                            }), e.currentBreakpoint = l, e.emit("_beforeBreakpoint", p), f && i && (e.loopDestroy(), e.loopCreate(), e.updateSlides(), e.slideTo(t - n + e.loopedSlides, 0, !1)), e.emit("breakpoint", p)
                        }
                    }
                },
            ...
            classes: {
                addClasses: function () {
                    ...
                    n.push.apply(n, p), o.addClass([].concat(n).join(" ")), a.emitContainerClasses()
                },
            ...
            images: {
                loadImage: function (e, t, i, a, n, r) {
                    ...
                    m(e).parent("picture")[0] || e.complete && n ? d() : t ? ((s = new l.Image).onload = d, s.onerror = d, a && (s.sizes = a), i && (s.srcset = i), t && (s.src = t)) : d()
                },
        ...
        j = function () {
            function t() {
                ...
                if (1 === n.length && n[0].constructor && n[0].constructor === Object ? i = n[0] : (e = n[0], i = n[1]), i || (i = {}), i = S({}, i), e && !i.el && (i.el = e), i.el && m(i.el).length > 1) {
                    var s = [];
                ...
                var l, d, p = S({}, H);
                return o.useParams(p), o.params = S({}, p, V, i), o.originalParams = S({}, o.params), o.passedParams = S({}, i), o.params && o.params.on && Object.keys(o.params.on).forEach((function (e) {
            ...
            return r.emitContainerClasses = function () {
                ...
                if (t.centeredSlides) {
                    ...
                    for (var p = r - 1; p >= 0; p -= 1) i[p] && !o && (s += 1, (l += i[p].swiperSlideSize) > n && (o = !0))
                } else
                ...
                return !!(e = a[0]) && (e.swiper = t, e && e.shadowRoot && e.shadowRoot.querySelector ? (i = m(e.shadowRoot.querySelector("." + t.params.wrapperClass))).children = function (e) {
                    return a.children(e)
                } : i = a.children("." + t.params.wrapperClass), S(t, {
                    $el: a,
                    el: e,
                    $wrapperEl: i,
                    wrapperEl: i[0],
            ...
            }], (a = null) && e(i.prototype, a), n && e(i, n), t
        }();
    ...
    var _ = {
            ...
            update: function () {
                ...
                if (!e.params.loop) {
                    var a = e.navigation,
                        n = a.$nextEl,
                        r = a.$prevEl;
                    r && r.length > 0 && (e.isBeginning ? i(r, !0) : i(r, !1), r[e.params.watchOverflow && e.isLocked ? "addClass" : "removeClass"](t.lockClass)), n && n.length > 0 && (e.isEnd ? i(n, !0) : i(n, !1), n[e.params.watchOverflow && e.isLocked ? "addClass" : "removeClass"](t.lockClass))
                }
            },
            ...
            init: function () {
                ...
                (a.nextEl || a.prevEl) && (a.nextEl && (e = m(a.nextEl), i.params.uniqueNavElements && "string" == typeof a.nextEl && e.length > 1 && 1 === i.$el.find(a.nextEl).length && (e = i.$el.find(a.nextEl))), a.prevEl && (t = m(a.prevEl), i.params.uniqueNavElements && "string" == typeof a.prevEl && t.length > 1 && 1 === i.$el.find(a.prevEl).length && (t = i.$el.find(a.prevEl))), e && e.length > 0 && e.on("click", i.navigation.onNextClick), t && t.length > 0 && t.on("click", i.navigation.onPrevClick), S(i.navigation, {
                    $nextEl: e,
                    nextEl: e && e[0],
                    $prevEl: t,
                    prevEl: t && t[0]
            ...
            update: function () {
                ...
                if (i.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                    ...
                    if (e.params.loop ? ((a = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup)) > n - 1 - 2 * e.loopedSlides && (a -= n - 2 * e.loopedSlides), a > s - 1 && (a -= s), a < 0 && "bullets" !== e.params.paginationType && (a = s + a)) : a = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0, "bullets" === i.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
                        ...
                        if (i.dynamicBullets && (e.pagination.bulletSize = p.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0), r.css(e.isHorizontal() ? "width" : "height", e.pagination.bulletSize * (i.dynamicMainBullets + 4) + "px"), i.dynamicMainBullets > 1 && void 0 !== e.previousIndex && (e.pagination.dynamicBulletIndex += a - e.previousIndex, e.pagination.dynamicBulletIndex > i.dynamicMainBullets - 1 ? e.pagination.dynamicBulletIndex = i.dynamicMainBullets - 1 : e.pagination.dynamicBulletIndex < 0 && (e.pagination.dynamicBulletIndex = 0)), o = a - e.pagination.dynamicBulletIndex, d = ((l = o + (Math.min(p.length, i.dynamicMainBullets) - 1)) + o) / 2), p.removeClass(i.bulletActiveClass + " " + i.bulletActiveClass + "-next " + i.bulletActiveClass + "-next-next " + i.bulletActiveClass + "-prev " + i.bulletActiveClass + "-prev-prev " + i.bulletActiveClass + "-main"), r.length > 1) p.each((function (e) {
                            var t = m(e),
                                n = t.index();
                        ...
                        if (i.dynamicBullets) {
                            var y = Math.min(p.length, i.dynamicMainBullets + 4),
                                ...
                                C = t ? "right" : "left";
                            p.css(e.isHorizontal() ? C : "top", b + "px")
                        }
                    }
                    if ("fraction" === i.type && (r.find("." + i.currentClass).text(i.formatFractionCurrent(a + 1)), r.find("." + i.totalClass).text(i.formatFractionTotal(s))), "progressbar" === i.type) {
                        ...
                        var T = (a + 1) / s,
                            E = 1,
                            S = 1;
                        "horizontal" === w ? E = T : S = T, r.find("." + i.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + E + ") scaleY(" + S + ")").transition(e.params.speed)
                    }
        ...
        q = {
                    ...
                    !n.hasClass(a.elementClass) || n.hasClass(a.loadedClass) || n.hasClass(a.loadingClass) || r.push(n[0]), 0 !== r.length && r.each((function (e) {
                        ...
                        i.loadImage(r[0], o || s, l, d, !1, (function () {
                            if (null != i && i && (!i || i.params) && !i.destroyed) {
                                if (s ? (r.css("background-image", 'url("' + s + '")'), r.removeAttr("data-background")) : (l && (r.attr("srcset", l), r.removeAttr("data-srcset")), d && (r.attr("sizes", d), r.removeAttr("data-sizes")), p.length && p.children("source").each((function (e) {
                                        var t = m(e);
            ...
            load: function () {
                ...
                if ("auto" === o && (o = 0), e.lazy.initialImageLoaded || (e.lazy.initialImageLoaded = !0), e.params.watchSlidesVisibility) t.children("." + i.slideVisibleClass).each((function (t) {
                    ...
                    for (var p = n; p < n + o; p += 1) l(p) && e.lazy.loadInSlide(p);
                else e.lazy.loadInSlide(n);
                if (s.loadPrevNext)
                    if (o > 1 || s.loadPrevNextAmount && s.loadPrevNextAmount > 1) {
                        for (var u = s.loadPrevNextAmount, c = o, v = Math.min(n + c + Math.max(u, c), a.length), f = Math.max(n - Math.max(c, u), 0), h = n + o; h < v; h += 1) l(h) && e.lazy.loadInSlide(h);
            ...
            on: {
                ...
                click: function (e, t) {
                    var i = e.navigation,
                        ...
                        n = i.$prevEl,
                        r = t.target;
                    if (e.params.navigation.hideOnClick && !m(r).is(n) && !m(r).is(a)) {
